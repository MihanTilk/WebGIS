...
# Real Sri Lankan towns (lon, lat). Spawning around these keeps assets on land
# and looks like a realistic distribution, instead of a uniform box that would
# include large stretches of ocean.
SRI_LANKA_CITIES = [
